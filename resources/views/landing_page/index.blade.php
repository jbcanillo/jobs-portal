	    ...
	    <section class="hero-area bg-1">
	        <div class="container">
	            <div class="row">
	                <div class="col-md-7">
	                    <div class="block">
	                        <h1 class="wow fadeInDown" data-wow-delay="0.3s" data-wow-duration=".2s" >Neway - Manpower Sevices Inc.</h1>
	                        <p class="wow fadeInDown" data-wow-delay="0.5s" data-wow-duration=".5s" style="color:black"><b>To eleviate peoples life by giving a new opportunity to work.<br>
                                    A portal that opens possibilities of improving life of job seeker while  ensuring quality of services to its clients.</b></p>
	                        <div class="wow fadeInDown" data-wow-delay="0.7s" data-wow-duration=".7s">
	                        	<a class="btn btn-home" href="#about" role="button">Register Now</a>
	                        </div>
	                    </div>
	                </div>
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-12 wow fadeInLeft">
                        <div class="content">
                        	<div class="sub-heading">
                        		<h3>To eleviate peoples life by giving a new opportunity to work.<br>
                                    A portal that opens possibilities of improving life of job seeker while  ensuring quality of services to its clients.</h3>
                        	</div>
                    ...
                    <div class="col-md-5 col-sm-12 wow fadeInLeft" data-wow-delay="0.3s">
                        <div class="about-slider">
                            ...
                            <img src="{{ asset('template/landing_page/images/about/2.jpg') }}" alt="">
