...
@section('content')
        <div class="card">
          <div class="card-header card-header-tabs card-header-info">
            <h4 class="card-title"><i class="material-icons">people</i> Employers 
              <span class="pull-right">
                <a href="{{action('EmployersController@create')}}" class="btn btn-sm btn-success"><i class="material-icons">add</i></a>
              </span>
            </h4>
          </div>
          <div class="card-body">
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
      function deleteRecord(id){
            bootbox.confirm({
                      message: "Are you sure you want to delete this employer record?",
                      buttons: {
                          confirm: {
                              label: 'Yes',
                      ...
                      callback: function (result) {
                          $.ajax({
                            ...
                            success: function( msg ) {
                              if(result==true){
                                window.location.href = "/employers/delete/"+id;
                              }
                            }
                          });
                      }
