             ...
             columns: [
                        ...
                        { 
                          "render": function ( data, type, full, meta ) { 
                           return '<a href="#" onclick="viewRecord(\''+xlink+'\','+full.id+');" class="btn btn-sm btn-primary"><i class="material-icons">visibility</i><a href="/applicants/'+full.id+'/edit" class="btn btn-sm btn-warning"><i class="material-icons">edit</i></a><a href="#" onclick="deleteRecord('+full.id+');" class="btn btn-sm btn-danger"><i class="material-icons">close</i></a>';
                           }
                        }  
                     ],
                     dom: 'Bfrtip',
